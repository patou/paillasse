...
FIC_FRANCE_DEPARTEMENTS_INSEE = REP_GEODATA + 'departement2020.csv'
FIC_FRANCE_REGIONS_INSEE = REP_GEODATA + 'region2020.csv'
...
class Commune(object):
    ...
    def __init__(self, _typecom, _codecommune, _coderegion, _codedepartement, _codearr,
